...
|                                    | $\tilde y_{t+h}$<br />(Recursive)                | $\tilde y_{t+h}$<br />(Batch)           | Weightage to history                |                                                                  | Parameter|
|---                                 | ---                                     | ---                                 | ---                                                              | ---|---                                 |
...
|Double EMA | $\tilde L_t + h \tilde T_t$<br />$\tilde T_t = \beta(\tilde L_t - \tilde L_{t-1}) + (1-\beta) \tilde T_{t-1}$<br />$\tilde L_t = \alpha L_t + (1-\alpha) (\tilde L_{t-1} + \tilde T_{t-1})$ |  |  |  | |
|Triple EMA | $(\tilde L_t + h \tilde T_t) \tilde s_{t+h-s}$<br /><br />$\tilde L_t = \alpha \dfrac{y_t}{\tilde S_{t-s}} + (1-\alpha)(y_{t-1} + \tilde T_{t-1})$<br />$\tilde T_t = \beta(\tilde L_t-\tilde L_{t-1}) + (1-\beta) \beta_{t-1}$<br />$\tilde S_t = \gamma \dfrac{y_t}{\tilde L_t} + (1-\gamma) \tilde S_{t-s}$ |  |  |  | |
