...
| Heat Pump     | - maintain warm temp<br />- Reverse HE | $\begin{align} \text{COP}_{HP} &= \frac{Q_\text{H}}{W_\text{net, in}} \\ &= \frac{1}{ 1 - \frac{Q_\text{L}}{Q_\text{H}} } \end{align}$ | $\begin{align} \text{COP}_{HP} &= \text{COP}_{R} + 1 \\
\text{COP}_{HP} &> \text{COP}_{R} \end{align}$ |                                                              |
