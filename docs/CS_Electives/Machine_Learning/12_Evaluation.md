...
It is invalid to use a standard hypothesis test - such as a T-test - across the different folds of a cross-validation, as the runs are not independent.
...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| Random residuals                                             | - No relationship between error and independent variables<br />- No relationship between error and predictions<br/>- If there is correlation, $\exists$ unexplained system component                                                             | Normality test<br />$E(a \vert b) = 0$<br />$r(a, b) = 0$<br>$\text{MI}(a, b) = 0$<br><br>$a \in [u, \vert u \vert , u^2, \log \vert u \vert]$<br><br>$b \in [ c, \vert c \vert , c^2, \log \vert c \vert]$<br>$c \in [x_j, y, \hat y]$ | Q-Q Plot<br>Histogram<br>Parallel coordinates plot<br><br>    | ❌ Unbiased parameters                                                                                                                                                                                                                                                                                                    | Fix model misspecification                                                                                         |
