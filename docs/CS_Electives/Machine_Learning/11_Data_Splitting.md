...
|                                                              |                            Train                             |                   Eyeball Development                   |       Black Box Development<br />(Inner Validation)       |            Validation<br />(Outer Validation)             |                     Test<br />(Holdout)                      |
| ------------------------------------------------------------ | :----------------------------------------------------------: | :-----------------------------------------------------: | :-------------------------------------------------------: | :-------------------------------------------------------: | :----------------------------------------------------------: |
| Recommend split %                                            |                              50                              |                           10                            |                            10                             |                            10                             |                              20                              |
...
| $\hat f$                                                     |                     ${\hat f}_\text{in}$                     |                 ${\hat f}_\text{edev}$                  |                  ${\hat f}_\text{bdev}$                   |                   ${\hat f}_\text{val}$                   |                    ${\hat f}_\text{test}$                    |
| $\hat f$ trained on                                          |                            Train                             |                          Train                          |                        Train+edev                         |                      Train+eDev+bDev                      |                     Train+eDev+bDev+Val                      |
| $E$                                                          |                        $E_\text{in}$                         |                     $E_\text{edev}$                     |                      $E_\text{bdev}$                      |                      $E_\text{val}$                       |                       $E_\text{test}$                        |
...
| ${\vert H \vert}_\text{set}$                                 |                           $\infty$                           |                      $d_\text{vc}$                      |                       $d_\text{vc}$                       |               ${\vert H \vert}_\text{val}$                |                             $1$                              |
| Comment                                                      |                                                              |                                                         |                                                           |    Used for “training” on “finalist” set of hypotheses    |       Should not be used for any model decision making       |
| Color Scheme Below                                           |   <span style="background:green;color:white">Green</span>    | <span style="background:green;color:white">Green</span> | <span style="background:yellow;color:black">Yellow</span> | <span style="background:orange;color:white">Orange</span> |     <span style="background:Red;color:white">Red</span>      |
