...
P-hacking, specification search, data dredging, fishing

## Data Snooping/Specification Search
...
- Explicit: Intentionally trying trying many models on the same training data
- Implicit: It doesn’t have to be explicit; sometimes we do data snooping mentally by looking at the data before choosing a model
