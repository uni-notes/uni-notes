...
|                       |                   Bias                    |              Variance<br />$\text{Var}(\hat f)$              |    Distribution Mismatch     | Bayes’ Error/<br />Stochastic Noise |
| :-------------------: | :---------------------------------------: | :----------------------------------------------------------: | :--------------------------: | :---------------------------------: |
...
| Bias                  | ⬆️                                                            | ⬇️                                          | ⬇️                                                            |
| Variance              | ⬇️                                                            | ⬇️                                          | ⬆️                                                            |
| Meaning               | Not fitting the signal enough                                | Fitting the signal<br />Avoiding the noise | Fitting the signal<br />Fitting the noise                    |
